...
// Node variables: ADC active and inactive settings
// (200mOhm resistor, 200 gain, 4.096V ADC reference, 4096 bits)
#define NV_COBALT_ACTIVE 1380       // 34.5mA
#define NV_COBALT_INACTIVE 2600     // 65.0mA
#define NV_TORTOISE_ACTIVE 160      // 4.0mA
#define NV_TORTOISE_INACTIVE 512    // 12.8mA
