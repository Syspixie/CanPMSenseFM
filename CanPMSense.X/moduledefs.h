...
#define MODULE_ID 98                    // MERG module ID
#define MODULE_TYPE_NAME "PMSENSE"      // MERG module name (7 characters)
...
// Queued messages
#define TXMSG_QUEUE_LENGTH 16           // Must be power of 2
